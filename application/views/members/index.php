...
<thead>
<tr class="table-header"><td><?php echo lang("ctn_191") ?></td><td><?php echo lang("ctn_358") ?></td><td><?php echo lang("ctn_359") ?></td><td><?php echo lang("ctn_322") ?></td><td><?php echo lang("ctn_194") ?></td><td><?php echo lang("ctn_195") ?></td></tr>
</thead>
<tbody>
</tbody>
</table>
   ...
   var st = $('#search_type').val();
    var table = $('#member-table').DataTable({
      ...
      "processing": false,
        ...
        "ajax": {
            url : "<?php echo site_url("members/members_page") ?>",
            type : 'GET',
            data : function ( d ) {

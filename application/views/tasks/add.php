...
<div class="panel-body">
 ...
 <?php echo form_open(site_url("tasks/add_task_process"), array("class" => "form-horizontal")) ?>
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <input type="text" class="form-control" name="price" value="" onkeypress="return isNumber(event)">
                </div>
            </div>
            <div class="form-group">
                <label for="p-in" class="col-md-4 label-heading"><?php echo lang("ctn_1414") ?></label>
                <div class="col-md-8">
                    <input type="text" class="form-control" name="hours" value="" onkeypress="return isNumber(event)">
                </div>
            </div>
            <div class="form-group">

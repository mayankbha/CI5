...
<tr><td><?php echo $r->name ?></td><td><?php if($r->default) { echo lang("ctn_53");}else{ echo lang("ctn_54"); } ?></td><td><a href="<?php echo site_url("admin/edit_group/" . $r->ID) ?>" class="btn btn-warning btn-xs" title="<?php echo lang("ctn_55") ?>" data-toggle="tooltip" data-placement="bottom"><span class="glyphicon glyphicon-cog"></span></a> <a href="<?php echo site_url("admin/delete_group/" . $r->ID . "/" . $this->security->get_csrf_hash()) ?>" class="btn btn-danger btn-xs" onclick="return confirm('Are you sure you want to delete this?')" title="<?php echo lang("ctn_57") ?>" data-toggle="tooltip" data-placement="bottom"><span class="glyphicon glyphicon-trash"></span></a>
 <a href="<?php echo site_url("admin/view_group/" . $r->ID) ?>" class="btn btn-primary btn-xs"><?php echo lang("ctn_58") ?></a></td></tr>
<?php endforeach; ?>
</table>

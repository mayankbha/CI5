...
<tr><td><?php echo $r->username ?></td><td><?php echo $r->name ?></td><td><a href="<?php echo site_url("admin/remove_user_from_group/" . $r->userid . "/" . $r->groupid . "/" . $this->security->get_csrf_hash()) ?>" data-toggle="tooltip" data-placement="bottom" class="btn btn-danger btn-xs" title="<?php echo lang("ctn_130") ?>"><span class="glyphicon glyphicon-trash"></span></a></td></tr>
<?php endforeach; ?>
</table>

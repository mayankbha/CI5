    ...
    <div class="modal-content">
      ...
      <?php echo form_open(site_url("admin/add_payment_plan"), array("class" => "form-horizontal")) ?>
            ...
            <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" id="username" name="color">
                        </div>
            </div>
            <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" id="username" name="fontcolor">
                        </div>
            </div>
            <div class="form-group">

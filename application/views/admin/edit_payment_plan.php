...
<div class="form-group">
        ...
        <div class="col-md-9">
            <input type="text" class="form-control" id="email-in" name="color" value="<?php echo $plan->hexcolor ?>">
        </div>
</div>
<div class="form-group">
        <label for="username-in" class="col-md-3 label-heading"><?php echo lang("ctn_272") ?></label>
        <div class="col-md-9">
            <input type="text" class="form-control" id="username" name="fontcolor" value="<?php echo $plan->fontcolor ?>">
        </div>
</div>
<div class="form-group">

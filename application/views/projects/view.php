...
<div class="row content-separator">
    <div class="col-md-8">
        ...
        <div class="white-area-content">
            ...
            <br/>
            <div class="project-info project-block">
                <p class="project-info-bit"><?php echo date('Y, M d', strtotime($project->date_start)) ?></p>
                <p class="project-info-title"><?php echo lang("ctn_644") ?></p>
            </div>

            <?php $project_price = 0; $project_hours = 0; ?>
            <?php foreach($tasks->result() as $r) : ?>
                <?php $project_price += $r->price; ?>
                <?php $project_hours += $r->hours; ?>
            <?php endforeach; ?>
            <div class="project-info project-block">
                <p class="project-info-bit">$<?php echo number_format($project_price, 2) ?></p>
                <p class="project-info-title"><?php echo lang("ctn_1411") ?></p>
            </div>

            <div class="project-info project-block">
                <p class="project-info-bit"><?php echo $project_hours ?></p>
                <p class="project-info-title"><?php echo lang("ctn_1412") ?></p>
            </div>
        </div>
            ...
            <div class="white-area-content content-separator">
                ...
                <div class="table-responsive">
                    <table id="tasks-table" class="table table-bordered table-striped table-hover">
                        <thead>
                        <tr class="table-header"><td><?php echo lang("ctn_847") ?></td><td><?php echo lang("ctn_1413") ?></td><td><?php echo lang("ctn_1414") ?></td><td><?php echo lang("ctn_848") ?></td><td><?php echo lang("ctn_825") ?></td><td><?php echo lang("ctn_849") ?></td><td><?php echo lang("ctn_828") ?></td><td><?php echo lang("ctn_52") ?></td></tr>
                        </thead>

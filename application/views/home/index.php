...
<div class="fp-project">
	<p><a href="<?php echo site_url("projects/view/" . $r->ID) ?>"><img src="<?php echo base_url() ?><?php echo $this->settings->info->upload_path_relative ?>/<?php echo $r->image ?>"  data-toggle="tooltip" data-placement="bottom" title="<?php echo strip_tags($r->description) ?>"></a></p>
...
<a href="#" class="btn btn-primary" data-toggle="modal" data-target="#construction-modal" id="test">Manage</a>


<div id="construction-modal" class="modal fade" role="dialog">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <h3><span class="glyphicon glyphicon-exclamation-sign sidebar-icon sidebar-icon-red"></span>Site is under construction</h3>
                        <p class="text-default">Our site is currently undergoing maintenance and upgrades. Thank you for your patience.</p>
                    </div>
                </div>
            </div>

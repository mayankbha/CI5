...
<!--              </li>-->
			...
			<?php //if($this->common->has_permissions(array("admin", "project_admin", "reports_manage", "reports_worker"), $this->user)) : ?>
              <li id="quote_links">
                  ...
                  <div id="proposal_links_c" class="panel-collapse collapse sidebar-links-inner <?php if(isset($activeLink['proposal'])) echo "in" ?>">
                    <ul class="inner-sidebar-links">
					  ...
					  <li class="<?php if(isset($activeLink['proposal']['all'])) echo "active" ?>"><a href="<?php echo site_url("proposals/index/0") ?>"> <?php echo 'All'; //echo lang("ctn_1146") ?></a></li>
                      <li class="<?php if(isset($activeLink['proposal']['draft'])) echo "active" ?>"><a href="<?php echo site_url("proposals/index/1") ?>"> <?php echo 'Draft'; //echo lang("ctn_1147") ?></a></li>
                      <li class="<?php if(isset($activeLink['proposal']['sent'])) echo "active" ?>"><a data-toggle="collapse" href="#proposal_links_sent" class="collapsed <?php if(isset($activeLink['proposal']['sent'])) echo "active" ?>"><?php echo 'Sent'; //echo lang("ctn_1148") ?><span class="plus-sidebar"><span class="glyphicon glyphicon-menu-right"></span></span></a>
						 <div id="proposal_links_sent" class="panel-collapse collapse sidebar-links-inner <?php if(isset($activeLink['proposal']['sent'])) echo "in" ?>">
							<ul class="inner-sidebar-links">
								<li class="<?php if(isset($activeLink['proposal']['sent_pending_review'])) echo "active" ?>"><a href="<?php echo site_url("proposals/index/2") ?>"><?php echo 'Not Viewed'; ?></a></li>
								<li class="<?php if(isset($activeLink['proposal']['sent_pending_approval'])) echo "active" ?>"><a href="<?php echo site_url("proposals/index/3") ?>"><?php echo 'Viewed'; ?></a></li>
							</ul>
						 </div>
					  </li>
                      <!--<li class="<?php if(isset($activeLink['proposal']['received'])) echo "active" ?>"><a data-toggle="collapse" href="#proposal_links_received" class="collapsed"> <?php echo 'Received'; //echo lang("ctn_1149") ?><span class="plus-sidebar"><span class="glyphicon glyphicon-menu-right"></span></span></a>
						<div id="proposal_links_received" class="panel-collapse collapse sidebar-links-inner">
							<ul class="inner-sidebar-links">
								<li class="<?php if(isset($activeLink['proposal']['received_pending_review'])) echo "active" ?>"><a href="<?php echo site_url("proposals/index/4") ?>"><?php echo 'Not Viewed'; ?></a></li>
								<li class="<?php if(isset($activeLink['proposal']['received_pending_approval'])) echo "active" ?>"><a href="<?php echo site_url("proposals/index/5") ?>"><?php echo 'Viewed'; ?></a></li>
							</ul>
						 </div>
					  </li>-->
					  <li class="<?php if(isset($activeLink['proposal']['accepted'])) echo "active" ?>"><a href="<?php echo site_url("proposals/index/6") ?>"> <?php echo 'Accepted'; //echo lang("ctn_1149") ?></a></li>
					  <li class="<?php if(isset($activeLink['proposal']['declined'])) echo "active" ?>"><a href="<?php echo site_url("proposals/index/7") ?>"> <?php echo 'Declined'; //echo lang("ctn_1149") ?></a></li>
					  <li class="<?php if(isset($activeLink['proposal']['templates'])) echo "active" ?>"><a href="<?php echo site_url("proposals/index/templates") ?>"> <?php echo 'Templates'; //echo lang("ctn_1149") ?></a></li>
                    </ul>
                  </div>
              </li>
            <?php //endif; ?>
			...
			<?php if($this->common->has_permissions(array("admin"), $this->user)) : ?>
				<li class="<?php if(isset($activeLink['templates']['general'])) echo "active" ?>"><a href="<?php echo site_url("proposals/templates") ?>"><span class="glyphicon glyphicon-cog sidebar-icon sidebar-icon-orange"></span> <?php echo 'Templates'; //echo lang("ctn_156") ?></a></li>
			<?php endif;?>

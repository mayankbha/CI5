...
<?php endif; ?>
    ...
    <div id="footer" class="clearfix">
      <span class="pull-left"><?php echo lang("ctn_170") ?> <a href="https://www.advancedmarketersinstitute.com/">AMI Development</a> <?php echo $this->settings->info->site_name ?> V<?php echo $this->settings->version ?></span> <span class="pull-right"><a href="<?php echo site_url("home/change_language") ?>"><?php echo lang("ctn_171") ?></a></span>
    </div>
				...
				<div class="modal-body">
					<div role="tabpanel">
						...
						<ul class="nav nav-tabs" role="tablist">
							<li role="presentation" class="active"><a href="#blank" aria-controls="blank" role="tab" data-toggle="tab">Blank</a></li>

							<li role="presentation"><a href="#public" aria-controls="public" role="tab" data-toggle="tab">Public</a></li>

							<li role="presentation"><a href="#uploads" aria-controls="uploads" role="tab" data-toggle="tab">My Templates</a></li>
						</ul>
						...
						<div class="tab-content">
									...
									<div class="row">
										<div class="col-sm-4">
											<div class="col-sm-12 text-center">
												<a href="<?php echo site_url("proposals/edit/0"); ?>" target="_blank">
													<img class="img-responsive" src="<?php echo base_url(); ?>images/blank_template.png" />
							...
							<div role="tabpanel" class="tab-pane" id="public">
								<?php $public_templates = $this->common->get_public_templates(); ?>

								<div class="modal-body">
									<div class="row">
										<?php if(!empty($public_templates)) { ?>
											<?php foreach($public_templates as $public_template) { ?>
												<div class="col-sm-4">
													<div class="col-sm-12 thumbnail text-center">
														<a href="<?php echo site_url("proposals/edit/".$public_template['template_id']); ?>" target="_blank">
															<img class="img-responsive" src="<?php echo base_url(); ?>images/<?php echo $public_template['image']; ?>" />

															<div class="caption">
                                                                <?php echo $public_template['title']; ?>
															</div>
														</a>
													</div>
												</div>
							...
							<div role="tabpanel" class="tab-pane" id="uploads">
								<?php $user_templates = $this->common->get_user_templates($this->user->info->ID); ?>

								<div class="modal-body">
									<div class="row">
										<?php if(!empty($user_templates)) { ?>
											<?php foreach($user_templates as $user_template) { ?>
												<div class="col-sm-4">
													<div class="col-sm-12 thumbnail text-center">
														<a href="<?php echo site_url("proposals/edit/".$user_template['template_id']); ?>" target="_blank">
															<img class="img-responsive" src="<?php echo base_url(); ?>images/<?php echo $user_template['image']; ?>" />

															<div class="caption">
																<?php echo $user_template['title']; ?>
															</div>
														</a>
													</div>
												</div>

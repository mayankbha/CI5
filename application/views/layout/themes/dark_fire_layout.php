...
<?php endif; ?>
    ...
    <div class="user-sidebar-area">
          ...
          <div class="media-left">
            <img src="<?php echo base_url() ?><?php echo $this->settings->info->upload_path_relative ?>/<?php echo $this->user->info->avatar ?>" class="user_avatar user-sidebar-icon">
          </div>
          <div class="media-body">
            <p class="no-p-margin"><?php echo lang("ctn_1264") ?> <?php echo $this->user->info->first_name ?></p>
            <p class="small-text">@<a href="<?php echo site_url("profile/" . $this->user->info->username) ?>"><?php echo $this->user->info->username ?></a></p>
          </div>
          </div>
        </div>

        <div class="user-sidebar-icons">
          <a href="<?php echo site_url("user_settings") ?>" data-toggle="tooltip" data-placement="top" title="<?php echo lang("ctn_156") ?>"><span class="glyphicon glyphicon-cog"></span></a> <a href="<?php echo site_url("mail") ?>"><span class="glyphicon glyphicon-envelope" data-toggle="tooltip" data-placement="top" title="<?php echo lang("ctn_1263") ?>"></span></a> <a href="<?php echo site_url("home/notifications") ?>" data-toggle="tooltip" data-placement="top" title="<?php echo lang("ctn_559") ?>"><span class="glyphicon glyphicon-bell"></span></a> <a href="<?php echo site_url("profile/" . $this->user->info->username) ?>" data-toggle="tooltip" data-placement="top" title="<?php echo lang("ctn_200") ?>"><span class="glyphicon glyphicon-user"></span></a>
          </div>
        <?php endif; ?>

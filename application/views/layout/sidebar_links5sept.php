<ul class="newnav nav nav-sidebar">
           ...
           ($this->user->info->admin || $this->user->info->admin_settings || $this->user->info->admin_members || $this->user->info->admin_payment)
                    ...
                    <ul class="inner-sidebar-links">
                      ...
                      <?php if($this->common->has_permissions(array("admin", "project_admin", "team_manage"), $this->user)) : ?>
                        ...
                        <li class="<?php if(isset($activeLink['team']['roles'])) echo "active" ?>"><a href="<?php echo site_url("team/roles") ?>"> <?php echo lang("ctn_706") ?></a></li>
                          <li class="<?php if(isset($activeLink['team']['billing_roles'])) echo "active" ?>"><a href="<?php echo site_url("team/billing_roles") ?>"> <?php echo lang("ctn_1415") ?></a></li>
                      <?php endif; ?>
                    </ul>
                  </div>
              </li>
            ...
            <?php endif; ?>
    <li class="<?php if(isset($activeLink['services'])) echo "active" ?>"><a href="<?php echo site_url("services/overview") ?>">
            <span class="glyphicon glyphicon-th-list sidebar-icon sidebar-icon-blue"></span> <?php echo lang("ctn_1215") ?></a></li>
...
<!--              </li>-->
			...
			<?php //if($this->settings->info->enable_reports && $this->common->has_permissions(array("admin", "project_admin", "reports_manage", "reports_worker"), $this->user)) : ?>
              <li id="quote_links">
                  <a data-toggle="collapse" data-parent="#proposal_links" href="#proposal_links_c" class="collapsed <?php if(isset($activeLink['proposal'])) echo "active" ?>">
                    <span class="glyphicon glyphicon-list-alt sidebar-icon sidebar-icon-green"></span> <?php echo 'Proposal'; //echo lang("ctn_1141") ?>
                    <span class="plus-sidebar"><span class="glyphicon glyphicon-menu-right"></span></span>
                  </a>
                  <div id="proposal_links_c" class="panel-collapse collapse sidebar-links-inner <?php if(isset($activeLink['proposal'])) echo "in" ?>">
                    <ul class="inner-sidebar-links">
					  <li>
					  <a href="<?php echo site_url("proposals/create") ?>" data-toggle="modal" data-target="#myModal"> <?php echo 'Create New'; //echo lang("ctn_1146") ?></a>
					  </li>
					  <li class="<?php if(isset($activeLink['proposal']['all'])) echo "active" ?>"><a href="<?php echo site_url("proposals/index/0") ?>"> <?php echo 'All' .' ('.$all_proposal_cnt.')'; //echo lang("ctn_1146") ?></a></li>
                      <li class="<?php if(isset($activeLink['proposal']['draft'])) echo "active" ?>"><a href="<?php echo site_url("proposals/index/1") ?>"> <?php echo 'Draft'.' ('.$proposal_status_cnt[0]->draft_count.')'; //echo lang("ctn_1147") ?></a></li>
                      <li class="<?php if(isset($activeLink['proposal']['sent'])) echo "active" ?>"><a data-toggle="collapse" href="#proposal_links_sent" class="collapsed <?php if(isset($activeLink['proposal']['sent'])) echo "active" ?>"><?php echo 'Sent'.' ('.($proposal_status_cnt[0]->sent_pending_review_count + $proposal_status_cnt[0]->sent_pending_approval_count).')'; //echo lang("ctn_1148") ?><span class="plus-sidebar"><span class="glyphicon glyphicon-menu-right"></span></span></a>
						 <div id="proposal_links_sent" class="panel-collapse collapse sidebar-links-inner <?php if(isset($activeLink['proposal']['sent'])) echo "in" ?>">
							<ul class="inner-sidebar-links">
								<li class="<?php if(isset($activeLink['proposal']['sent_pending_review'])) echo "active" ?>"><a href="<?php echo site_url("proposals/index/2") ?>"><?php echo 'Pending Review'.' ('.$proposal_status_cnt[0]->sent_pending_review_count.')'; ?></a></li>
								<li class="<?php if(isset($activeLink['proposal']['sent_pending_approval'])) echo "active" ?>"><a href="<?php echo site_url("proposals/index/3") ?>"><?php echo 'Pending Approval'.' ('.$proposal_status_cnt[0]->sent_pending_approval_count.')'; ?></a></li>
							</ul>
						 </div>
					  </li>
                      <li class="<?php if(isset($activeLink['proposal']['received'])) echo "active" ?>"><a data-toggle="collapse" href="#proposal_links_received" class="collapsed"> <?php echo 'Received'.' ('.($proposal_status_cnt[0]->received_pending_review_count + $proposal_status_cnt[0]->received_pending_approval_count).')'; //echo lang("ctn_1149") ?><span class="plus-sidebar"><span class="glyphicon glyphicon-menu-right"></span></span></a>
						<div id="proposal_links_received" class="panel-collapse collapse sidebar-links-inner">
							<ul class="inner-sidebar-links">
								<li class="<?php if(isset($activeLink['proposal']['received_pending_review'])) echo "active" ?>"><a href="<?php echo site_url("proposals/index/4") ?>"><?php echo 'Pending Review'.' ('.$proposal_status_cnt[0]->received_pending_review_count.')'; ?></a></li>
								<li class="<?php if(isset($activeLink['proposal']['received_pending_approval'])) echo "active" ?>"><a href="<?php echo site_url("proposals/index/5") ?>"><?php echo 'Pending Approval'.' ('.$proposal_status_cnt[0]->received_pending_approval_count.')'; ?></a></li>
							</ul>
						 </div>
					  </li>
					  <li class="<?php if(isset($activeLink['proposal']['accepted'])) echo "active" ?>"><a href="<?php echo site_url("proposals/index/6") ?>"> <?php echo 'Accepted'.' ('.$proposal_status_cnt[0]->accepted_count.')'; //echo lang("ctn_1149") ?></a></li>
					  <li class="<?php if(isset($activeLink['proposal']['declined'])) echo "active" ?>"><a href="<?php echo site_url("proposals/index/7") ?>"> <?php echo 'Declined'.' ('.$proposal_status_cnt[0]->declined_count.')'; //echo lang("ctn_1149") ?></a></li>
                    </ul>
                  </div>
              </li>
            <?php //endif; ?>

...
class Team_Model extends CI_Model 
{
	...
	public function get_billing_roles()
	{
		return $this->db->get("project_billing_roles");
	}
	...
	public function add_billing_role($data)
	{
		$this->db->insert("project_billing_roles", $data);
	}
    ...
    public function get_billing_role($id)
    {
        return $this->db->where("ID", $id)->get("project_billing_roles");
    }
    ...
    public function update_billing_role($id, $data)
    {
        $this->db->where("ID", $id)->update("project_billing_roles", $data);
    }
	...
	public function delete_billing_role($id)
	{
		$this->db->where("ID", $id)->delete("project_billing_roles");
	}
